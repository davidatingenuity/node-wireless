...
Wireless.prototype.COMMANDS = {
    ...
    dhcp_disable: 'dhclient -r :INTERFACE; killall dhclient',
    leave: 'killall wpa_supplicant',

    metric: 'ifconfig :INTERFACE metric :METRIC',
    connect_wep: 'iw :INTERFACE connect ":ESSID" keys :PASSWORD',
    connect_wpa: 'wpa_passphrase ":ESSID" ":PASSWORD" > /tmp/wpa-temp.conf && wpa_supplicant -B -D nl80211 -i :INTERFACE -c /tmp/wpa-temp.conf && rm /tmp/wpa-temp.conf',
